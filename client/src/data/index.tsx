...
const jobsSlider = [
    {
        ...
        description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vitae, mollitia!",
...
const reviews = [
    ...
    // {
    //   name: "Sophia Davis",
    //   review: "Amazing experience, the product exceeded my expectations!",
    //   image: avatar2,
    //   rating: 4.9
    // },
    // {
    //   name: "Daniel Wilson",
    //   review: "Decent product for the price, but could be better.",
    //   image: avatar3,
    //   rating: 3.2
    // }
  ];
...
export { companies, jobsSlider, workingPoints, reviews}